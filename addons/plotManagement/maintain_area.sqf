...
switch true do {
	...
	case (_count <= 250): {_requirements = [["ItemBriefcase100oz",0]]};
	case (_count <= 325): {_requirements = [["ItemBriefcase100oz",0]]};
	case (_count <= 400): {_requirements = [["ItemBriefcase100oz",0]]};
	case (_count <= 475): {_requirements = [["ItemBriefcase100oz",0]]};
	case (_count <= 550): {_requirements = [["ItemBriefcase100oz",0]]};
	case (_count <= 625): {_requirements = [["ItemBriefcase100oz",0]]};
	case (_count > 625):  {_requirements = [["ItemBriefcase100oz",0]]};
};
